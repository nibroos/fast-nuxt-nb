...
<template>
  <div class="flex h-[80vh] flex-col gap-5" @click="updateHeight" v-if="isAllowed">
    <slot name="top" v-if="slots.top" />
    <slot name="action"></slot>
    <div v-if="!!mergedConfig.isAction"
      ...
      <div class="flex flex-row items-center justify-between">
        ...
        <div class="grid auto-cols-fr grid-flow-col gap-3 whitespace-nowrap"
          ...
          <d-button v-if="mergedConfig.button?.duplicate?.show"
            :cta="mergedConfig?.button?.duplicate?.cta ?? 'Duplicate'" :class="classMerge(
